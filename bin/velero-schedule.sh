...
# velero schedule create admin--1h --schedule="@every 1h" --include-cluster-resources=true --include-namespaces admin --snapshot-volumes=true --default-volumes-to-restic --ttl 24h0m0s && sleep 600
...
velero schedule create gitlab-agent--24h --schedule="@every 24h" --include-namespaces gitlab-agent --snapshot-volumes=true --default-volumes-to-restic --ttl 720h0m0s && sleep 600
...
velero schedule create gitlab-agent--720h --schedule="@every 720h" --include-namespaces gitlab-agent --snapshot-volumes=true --default-volumes-to-restic --ttl 8760h0m0s && sleep 600
