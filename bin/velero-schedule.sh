...
# velero schedule create admin--1h --schedule="@every 1h" --include-namespaces admin --snapshot-volumes=true --default-volumes-to-restic --ttl 24h0m0s && sleep 600
...
velero schedule create admin--24h --schedule="@every 24h" --include-namespaces admin --snapshot-volumes=true --default-volumes-to-restic --ttl 720h0m0s && sleep 600
...
velero schedule create admin--720h --schedule="@every 720h" --include-namespaces admin --snapshot-volumes=true --default-volumes-to-restic --ttl 8760h0m0s && sleep 600
